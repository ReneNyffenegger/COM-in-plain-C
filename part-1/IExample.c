...
// #define MB(msg) MessageBox(0, msg, "msg", 0)
   #define MB(msg)
...
DLL_EXPORT HRESULT PASCAL DllGetClassObject(REFCLSID objGuid, REFIID factoryGuid, void **factoryHandle) {

	register HRESULT		hr;

  MB("DllGetClassObject");
...
DLL_EXPORT HRESULT PASCAL DllCanUnloadNow(void) {
  MB("DllCanUnloadNow");
